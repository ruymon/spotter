    ...
    <main className="flex flex-col items-center gap-24 bg-background">
      ...
      <MaxWidthWrapper className="flex flex-col gap-32 items-center w-full relative px-8 sm:px-16">
        ...
        <section className="flex flex-col w-full text-center gap-16 relative -mt-16 items-center">
          ...
          <figure className="w-full h-96 md:h-[32rem] overflow-clip relative z-[-2] pointer-events-none">
          ...
          <figure className="w-80 h-80 z-[-2] pointer-events-none absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 rounded-full blur-[200px] p-1 bg-violet-300 dark:bg-violet-900" />
          <figure className="w-80 h-80 z-[-2] pointer-events-none absolute bottom-0 translate-y-1/2 right-0 translate-x-1/2 rounded-full blur-[200px] p-1 bg-violet-300 dark:bg-violet-900/75" />
        </section>
